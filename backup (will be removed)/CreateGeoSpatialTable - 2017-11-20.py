...
##        self.deleteFiles()
        if not arcpy.Exists(self.AisGdbPath):
            ...
            self.createAISFeatureClass("AIS_FC", r"C:\AIS_Data\AIS_layer")
            print "Successful created AIS_FC"
...
##                arcpy.Delete_management("C:/AIS_Data/ais.lyr")
                ...
                self.appendFeatureClasses(r"C:\AIS_Data\ais.gdb\AIS_FC", r"C:\AIS_Data\ais.gdb\AIS_FC_TEMP")
